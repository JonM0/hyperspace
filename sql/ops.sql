...
-- CONTAINMENT
CREATE FUNCTION point4d_containedin_box4d(point4d, box4d) RETURNS bool AS '$libdir/hyperspace' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION box4d_contains_point4d(box4d, point4d) RETURNS bool AS '$libdir/hyperspace' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
...
CREATE FUNCTION point4d_containedin_circle4d(point4d, circle4d) RETURNS bool AS '$libdir/hyperspace' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION circle4d_contains_point4d(circle4d, point4d) RETURNS bool AS '$libdir/hyperspace' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
